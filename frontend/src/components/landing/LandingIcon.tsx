    ...
    <div className="order-1 flex shrink-0 justify-center md:order-2">
      <div className="relative h-40 w-40 shrink-0 sm:h-48 sm:w-48 md:h-56 md:w-56">
        <div
          ...
          style={{ boxShadow: '0 20px 60px -15px rgba(237,30,35,0.35)' }}
        >
          <div
            className="flex h-full w-full items-center justify-center rounded-full bg-[#ED1E23] text-white"
            style={{ background: 'linear-gradient(145deg, #ED1E23 0%, #c4181c 100%)' }}
          >
